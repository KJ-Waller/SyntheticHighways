...
if __name__ == '__main__':
    ...
    fscore_vs_noise(folder=f'./results_{args.exp_name}_seed{args.seed}/', savename=f'./results_{args.exp_name}_seed{args.seed}/fscore_vs_noise')
    plt.close()
    prauc_vs_noise(folder=f'./results_{args.exp_name}_seed{args.seed}/', savename=f'./results_{args.exp_name}_seed{args.seed}/prauc_vs_noise')